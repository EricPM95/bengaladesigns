/**
 * Las 5 categorías de filtro de la pantalla de explorar / añadir parada. `filter_category` viene del
 ...
 */
export type PlaceFilterCategory = 'monumentos' | 'museos_arte' | 'miradores' | 'gastronomia' | 'restaurantes'
...
export const PLACE_CATEGORY_CHIPS: PlaceCategoryChip[] = [
  ...
  // 'gastronomia' NO es lo mismo que 'restaurantes': son paradas de verdad de la ruta (un mercado
  // se visita, tiene duración y horario) que salen del array `places`, mientras que 'restaurantes'
  // sale de `restaurants` y nunca entra en el itinerario.
  { id: 'gastronomia', label: 'Mercados y Gastronomía', color: '#2E7D32', activeBg: '#E8F5E9', icon: '🧺' },
